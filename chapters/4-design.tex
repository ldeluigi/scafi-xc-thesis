...
%
The resulting code for the \texttt{distanceTo} construct is shown in \cref{lst:distance-to}, which resembles the syntax of the prototype \ac{DSL} of \cref{lst:lst:gradient-distance-xc-scala2-dsl}.
%
...
%
An \texttt{Export} instead is defined as an alias for a \texttt{MapWithDefault}, because it is able to send a dedicated message to a known neighbor and a default message to every other new neighbor of the device.
%
