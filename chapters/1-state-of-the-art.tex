...
%
\this, as well as FCPP in its current version, is based on this newer formal language, as discussed in \Cref{chap:background}, where \ac{FC} and \ac{XC} are briefly compared.
%
